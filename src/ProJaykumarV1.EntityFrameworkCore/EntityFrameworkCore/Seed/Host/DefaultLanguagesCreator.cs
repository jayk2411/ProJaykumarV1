...
namespace ProJaykumarV1.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = ProJaykumarV1Consts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(ProJaykumarV1DbContext context)
        {
            _context = context;
        }
