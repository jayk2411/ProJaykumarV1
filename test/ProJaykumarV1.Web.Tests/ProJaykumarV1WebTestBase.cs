...
{
    public abstract class ProJaykumarV1WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProJaykumarV1WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProJaykumarV1WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProJaykumarV1DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProJaykumarV1DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProJaykumarV1DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProJaykumarV1DbContext, Task<T>> func)
        {
            T result;
